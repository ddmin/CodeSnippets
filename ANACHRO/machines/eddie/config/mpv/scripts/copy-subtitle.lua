...
mp.add_key_binding('c', 'copy-subtitle-primary', function() copy_subtitle('sub-text') end)
mp.add_key_binding('C', 'copy-subtitle-primary-ass', function() copy_subtitle('sub-text-ass') end)
